...
| 10 | Sincronização de Frequentadores (espelho Sticapi) | 9 | ✅ Concluída (9/9) — inclui filtro de Órgão habilitado (10.9); filtro de Categoria pendente (sem fonte de dado) |
